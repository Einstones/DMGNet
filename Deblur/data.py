...
def build_dataset(args):
    ...
    # validation data
    valid_dataset = SIDDValData(args.testdata_path)
    valid_sampler = torch.utils.data.distributed.DistributedSampler(valid_dataset)
    valid_loader = u_data.DataLoader(valid_dataset, batch_size=args.testBatchSize, sampler=valid_sampler, num_workers=args.threads)
