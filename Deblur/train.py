...
def init_parse():
    ...
    parser.add_argument('--save_folder', default='/disk/gao1/PAMI/DeBlur/DMGNet/checkpoint/', help='Location to save checkpoint models')
    ...
    parser.add_argument('--sidd_path', default=r'/disk/hyd/Restormer/Motion_Deblurring/Datasets/GoPro', help='sidd path')
    parser.add_argument('--testdata_path', default=r'/disk/hyd/Restormer/Motion_Deblurring/Datasets/GoPro', help='sidd path')
...
def main():
    ...
    model = DMGNet(k=2, img_size=128, embed_dim=32, depths=[1, 2, 8, 8, 2, 8, 8, 2, 1], win_size=8, mlp_ratio=4., qkv_bias=True, downsample=Downsample, upsample=Upsample)    
